-- Clean RPC Functions - New Architecture Only
-- These functions work with the new fantasy_teams and active_nfl_teams structure
-- NO references to legacy active_qbs
...
-- Function to set fantasy lineup (clean - uses active_nfl_teams)
...
BEGIN
    ...
    -- Validate that all NFL teams exist (check against teams.uuid_id)
    IF EXISTS(
...
-- Function to get fantasy lineups for a week (clean - returns active_nfl_teams)
